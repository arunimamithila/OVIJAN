...
const Signup = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  const educationOptions = [
    { value: 'high_school', label: 'High School / Secondary', icon: BookOpen },
    ...
    { value: 'diploma', label: 'Diploma / Certificate', icon: Briefcase },
                    ...
                    <div style={{ display: "flex", gap: 12, marginTop: 20 }}>
                      ...
                      <motion.button
                        ...
                        style={{
                          flex: 1,
                          padding: "12px",
                          background: isFormValid() ? "linear-gradient(135deg, #22c55e 0%, #16a34a 100%)" : "rgba(255,255,255,0.1)",
                          border: "none",
                          borderRadius: 14,
