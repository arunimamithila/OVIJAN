...
import {
  ...
  User, Languages, ChevronRight, Workflow
} from 'lucide-react';
  ...
  const primaryNavItems = [
    ...
    { id: 'all-universities', icon: Building, label: 'Universities', path: '/all-universities' },
    {
      ...
      onClick: (navigate) => {
        ...
        if (userId) {
          navigate('/community', { state: { userId } });
        } else {
          navigate('/community');
        }
      }
...

    {
      ...
      onClick: (navigate) => {
        ...
        const userId = user?.userID || user?.id;
        if (userId) {
          navigate('/job', { state: { userId } });
        } else {
          navigate('/job');
        }
      }
    },
    { id: 'scholarshippage', icon: Award, label: 'ScholarShip', path: '/scholarshippage' },
    { id: 'cost', icon: DollarSign , label: 'Living Cost', path: '/cost' },
  ];
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div
                style={{
                  ...
                  fontWeight: '700',
                  fontSize: '15px',
                  boxShadow: '0 4px 12px rgba(60, 79, 73, 0.2)',
                  cursor: 'pointer'
                }}
              >
                <AvatarOnly size={39} />
